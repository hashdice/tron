...
var _addr = 'TGT4Jd8QKy7fDtZ27VKcqYKoe1kLTVQosm';
var _to = '';
var _value = 10000;
...
contract('HDT TRC20', function() {
    it("get balance", async function (){
        ...
        let _froze = await res.frozenOf(_addr).call();
        console.log("address: " + _addr + " Frozen: " + _froze); 

        let _thaws = await res.thawsOf(_addr).call();
        console.log("address: " + _addr + " Thaws: " + _thaws);           
    });          
    ...
    it("transfer", async function (){
        ...
        await res.transfer(_to, '10000000000000000').send();
    ...
    it("approve", async function (){
        ...
        await res.approve(_to, '70000000000000').send();
