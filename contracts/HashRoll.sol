...
contract HashRoll {
  ...
  // contants. (与币种相关)
  uint constant MAX_AMOUNT = 1048575 trx; //hex 0xFFFFF, 40 bits, max trx amount to bet.
  ...
  function placeRoll(uint8 _lowerLimit, uint8 _upperLimit, uint _commit, bytes32 _r, bytes32 _s)
    payable
    public
    onlyHuman
    onlyActive
